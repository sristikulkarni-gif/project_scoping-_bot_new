...
- **CRITICAL**: You MUST ONLY assign roles that are EXACTLY listed in the rate card database. Do NOT invent new roles like "Change Management Lead" if they are not part of the provided Rate Cards.
